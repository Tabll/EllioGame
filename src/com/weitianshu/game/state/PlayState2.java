...
//	public static Animation2 run2Anim;
	...
	//public static Bitmap xbrun1,xbrun2,xbrun3,xbrun4,xbrun5,xbrun6,xbrun7;
	...
	public void init() {
		...
		Frame f1 = new Frame(Assets.run1, .1f);
		Frame f2 = new Frame(Assets.run2, .2f);
		Frame f3 = new Frame(Assets.run3, .3f);
		Frame f4 = new Frame(Assets.run4, .4f);
		Frame f5 = new Frame(Assets.run5, .5f);
		Frame f6 = new Frame(Assets.run4, .6f);
		Frame f7 = new Frame(Assets.run2, .7f);
	...
	private void renderClouds(Painter g) {
		...
		g.drawImage(Assets.cloud2, (int)cloud2.getX() + 200, (int)cloud2.getY() + 100, 100, 60);
	}
